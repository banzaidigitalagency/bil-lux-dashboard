...
| Fichier | Contenu |
|---|---|
| [projet-etat.md](projet-etat.md) | État du projet : 8 canaux, stack, coefs billing, décisions, pièges connus. À jour au 2026-08-11 (périmètre des RPC restreint au BDC BELGIAN, chiffres de livraison) |
