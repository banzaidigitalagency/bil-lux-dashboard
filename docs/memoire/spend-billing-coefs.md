...
**Comment l'appliquer :**
- Toujours utiliser les RPC qui appliquent `get_billing_coef(client_id, platform)` au spend : `get_dashboard_kpis`, `get_dashboard_by_platform`, `get_dashboard_by_platform_daily`, et `get_dashboard_daily` (modifiee le 2026-04-21)
